...
async function deploymentCredentialsOrConfigure(ctx, chosenConfiguration, cmdOptions, partitionId) {
  ...
  if (cmdOptions.deploymentSelection.kind !== "ownDev" && cmdOptions.deploymentSelection.kind !== "ownProd" && cmdOptions.deploymentSelection.kind !== "deployKey" && cmdOptions.deploymentSelection.kind !== "projectKey") {
  ...
  if (cmdOptions.deploymentSelection.kind === "projectKey") {
    const {
      ...
      deploymentUrl: url2,
      adminKey: adminKey2
    } = await (0, import_api.fetchDeploymentCredentialsProvisioningDevOrProdMaybeThrows)(
      ctx,
      { teamSlug: null, projectSlug: null },
      cmdOptions.deploymentSelection.prod ? "prod" : "dev",
      partitionId
    );
    return { deploymentName: deploymentName2, url: url2, adminKey: adminKey2 };
  }
